...
/*   Updated: 2026/02/02 11:56:32 by rabdolho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#ifndef LIBFT_H
# define LIBFT_H
...
char				*sign_nbr_handler_decimal(char *sign, int n,
						t_flags *flags);
...
void				print_unsigned(unsigned int n, t_flags *flags,
						int *total_length);
void				print_hex_small(unsigned int n, t_flags *flags,
						int *total_length);
void				print_hex_big(unsigned int n, t_flags *flags,
						int *total_length);
